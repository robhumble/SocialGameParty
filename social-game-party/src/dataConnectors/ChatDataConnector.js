...
export default class ChatDataConnector extends DataConnector {
    ...
    //TODO: see issue #21, break chat out so it's no longer under a room (it should probably be in the chat room collection with a name that matches the current room.)
   /**
